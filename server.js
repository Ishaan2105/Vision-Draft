...
app.post('/send-otp', async (req, res) => {
    ...
    const mailOptions = {
        ...
        // This HTML matches the layout in your screenshot
        html: `
        <div style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; max-width: 600px; margin: auto; border: 1px solid #e0e0e0; border-radius: 12px; overflow: hidden;">
            <div style="background-color: #050505; padding: 30px; text-align: center;">
                <h1 style="color: white; margin: 0; font-style: italic; font-weight: 900; letter-spacing: -2px;">
                    VISION <span style="color: #0080ff;">DRAFT</span>
                </h1>
            </div>
            <div style="padding: 40px; background-color: #ffffff; color: #333333; line-height: 1.6;">
                <h2 style="color: #050505; margin-top: 0;">Verify your email</h2>
                <p>Thank you for choosing <strong>Vision Draft</strong>. Use the following code to complete your registration process. This code is valid for 5 minutes.</p>
                
                <div style="margin: 30px 0; text-align: center;">
                    <div style="display: inline-block; padding: 15px 40px; background-color: #f4f4f7; border-radius: 8px; border: 1px solid #ddd; font-size: 32px; font-weight: 900; letter-spacing: 10px; color: #0080ff;">
                        ${otp}
                    </div>
                </div>
                ...
                <p style="font-size: 12px; color: #888; text-align: center;">
                    &copy; 2026 Vision Draft AI. All rights reserved.<br>
                    Generated by Vision Draft Security System
                </p>
            </div>
        </div>
        `
